  ...
  return (
    <div className="sheet">
      ...
      <Line
        segs={[
          T("Общее образование: "),
          codeN("1", "дошкольное образование", v("education")),
          T("; "),
          codeN("2", "начальное общее образование", v("education")),
          T("; "),
          codeN("3", "основное общее образование", v("education")),
          T("; "),
          codeN("4", "среднее", v("education")),
        ]}
        h={3.9}
      />
      <Line
        segs={[
          codeRaw("общее образование; профессиональное образование", "4", v("education")),
          T("; "),
          codeN("5", "среднее профессиональное образование", v("education")),
          T("; "),
          codeN("6", "высшее образование", v("education")),
          T(";"),
        ]}
        h={3.9}
      />
...
export function Sheet2({ d }: { d: FormState }) {
  ...
  return (
    <div className="sheet" style={{ "--lh": "4.15mm" } as CSSProperties}>
      ...
      <Line
        segs={[
          T("Группа крови "), B(20, v("bloodGroup")),
          T(" резус-принадлежность "), B(32, v("rhesus")),
          T(" антиген К I системы Kell "), B(38, v("kell")),
          X(),
        ]}
        h={3.9}
      />
      ...
      <Line
        segs={[
          ...
          T(", в том числе в дневной стационар "),
          code("", "2", v("outcome")),
          T(", в стационар – 3."),
        ]}
        h={3.9}
